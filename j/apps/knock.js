...
KNOCKS4=function(){format()
    ...
    Task=function(d){return {t:ko.o(d.t),iD:ko.o(d.iD)}}


    TLVM=function(){
        
        var o={ts:ko.oa([]),nT:ko.o()}

        o.inc=ko.c(function(){
            return ko.ut.af(o.ts(),
...
KNOCKS=function(){format()


       s2(
           ul().k('fs').b("foreach:fs")(
...
KNOCKER=function(){format()
    ...
    s2(
      ...
      ip('r').at({name:'choices',value:'summary'}).b('c','selectedView'),
        sp('summary'),
        ip('r').at({name:'choices',value:'details'}).b('c','selectedView'),
        sp('details'),
...
KOEACH=function(){format()
    ...
    ko.ab({
        people:[
            {fn:'B',ln:'Bert'},{fn:'Ch',ln:'Char'},{fn:'De',ln:'Dent'}]
    })
...
KOEACH2=function(){
    ...
    s2(
        ...
        ul().b('E', 'people')(
            ...
            li()(sp('pos/name: '),sp().b('t','$index'),sp().b('t','n'),
                 lk(' X').b('$','$parent.rem'))),
