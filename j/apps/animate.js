TWEEN=function(a){//combo/complex/anim/tween
    ...
    wMs(function(b){
        ...
        tw([b//,'l'
            ...
            {x:0,sxy:.7,r:0},   [{x:300,sxy:2.3,r:0}, 1000],  [{x:0,sxy:.7,r:-30,a:.5},  3000])})
...
TWEENART=function(a){
    ...
    wMb(function(b,s){
        ...
        wMb(function(b){
            s.a(b);b.xy(200);b.rgc();b.wh(200);SL(b);

            tw([b,'l'],{r:0},[{r:360},1000])

            wMb(function(b){
                s.a(b);b.rgc();b.xy(600);SC(b)
...
EASING=function(){
    ...
    s=St(1000,10000).a()
    s.mg(function(b){b.sxy(.2).xy(50,100);tw([b,'l'], [{x:800},2000] , [{x:50},2000]   )})
...
SPRITE=function(sprite){sprite=sprite||SS
    ...
    var g=G(arguments),
        ...
        st=St('X',400).a().drg().t().op(.7),

        s = spr( jss(sprite) ).xy(10),ctr
    ...
    dva(5)(sp(' '),
        ...
        bt('meta',function(){ spri()  })

    ).c('y').h(80).w(430).a().t(200).l(300).P(20).op(.9)
...
PACK=function(){
    ...
    s=St(800).a().t().op(.7)
    // s.qC().l(100);s.qC().t(100)


    p = spr(jss(Pack)).rgc().xy(10).fn(TR).p().fr(6).xy(400,460).sxy(1.2).ap(s)
