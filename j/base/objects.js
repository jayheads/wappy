...
CSS={
    ...
    dt:"border-top",dtc:"border-top-color",dts:"border-top-style",dtw:"border-top-width",
    db:"border-bottom",dbc:"border-bottom-color",dbs:"border-bottom-style",
    dbw:"border-bottom-width",dr:"border-right",drc:"border-right-color",drs:"border-right-style",
    drw:"border-right-width",dl:"border-left",dlc:"border-left-color",dls:"border-left-style",dlw:"border-left-width",

    di:"border-image",dis:"border-image-source",
    dio:"border-image-outset",dir:"border-image-repeat",
    ...
    g:"padding",gt:"padding-top",gr:"padding-right",gb:"padding-bottom",gl:"padding-left",


    m:"margin",
    mt:"margin-top",mr:"margin-right",mb:"margin-bottom",
    ml:'margin-left',

    bt:"border-top-width",br:"border-right-width",bb:"border-bottom-width",
    ...
    s:"size", b:"bottom", cl:"clear",
    clp:'clip',u:'cursor',y:'display',
    fl:'float',l:'left',
...
DISPLAY={i:"inline",b:"block",ib:"inline-block",t:"table",n:"none",'#':"inherit",it:"inline-table",
    l:"list-item",c:"table-column",r:"table-row",cg:"table-column-group",rg:"table-row-group",
    p:"table-caption",h:"table-header-group",f:"table-footer-group",e:"table-cell"}
...
QMET={a:"after",A:'add',ab:'addBack',at:"appendTo",ap:"append",ac:"addClass",ar:"removeAttr",b:"before",
    cr:"removeClass",C:'contents',cl:"clone",d:"detach",e:"empty",F:'first',
    hc:"hasClass",h:"height",H:'hide',ia:"insertAfter",ib:"insertBefore",ih:"innerHeight",iw:"innerWidth",
    l:"html",L:'last',n:'next',na:'nextAll',po:"position",
    o:"offset",op:"offsetParent",oh:"outerHeight",ow:"outerWidth",pp:"prepend",P:"parent",ps:"parents",pu:"parentsUntil",
    p:"prop", pt:"prependTo", pr:"removeProperty", q:"eq", r:"remove", ra:"replaceAll", rw:"replaceWith",
    s:"css", S:'show', sl:"scrollLeft",sb:"siblings", st:"scrollTop", tt:"attr",
    tc:"toggleClass", t:"text",u:"unwrap", v:"val",w:"width",wr:"wrap", wa:"wrapAll", wi:"wrapInner", z:"size"}
COLOR={
    ad:"gray",a:"DarkGray",al:"LightGray",all:"Gainsboro",ae:"LightSlateGray",as:"Silver",aed:"SlateGray",add:"DimGray",
    bc:"Blue",be:"CadetBlue",j:"RoyalBlue",bg:"SteelBlue",bm:"SlateBlue",br:"DodgerBlue",bs:"MediumBlue",b:"CornflowerBlue",
    c:"Coral",cl:"LightCoral",dd:"GoldenRod",dp:"DarkGoldenRod",dl:"PaleGoldenRod",dd:"LightGoldenRodYellow",
    e:"Cyan",et:"Turquoise",ett:"MediumTurquoise",etp:"PaleTurquoise ",etd:"DarkTurquoise",eq:"Aqua",
    g:"ForestGreen",fgt:"Teal",fd:"DarkGreen",efy:"DarkCyan",fh:"SeaGreen",fg:"Green",f:"SpringGreen",
    gnn:"MediumSpringGreen",gp:"PaleGreen",gl:"LightGreen",igy:"YellowGreen",
    h:"LawnGreen",hgvv:"Chartreuse",he:"Lime",heg:"LimeGreen",hy: "GreenYellow",hc:"MediumSeaGreen",hl:"LightSeaGreen",
    ehmm:"MediumAquaMarine",ehm:"Aquamarine",i:"DarkSeaGreen",ig:"Olive",iv:"OliveDrab",id:"DarkOliveGreen",jm:"MidnightBlue",jn:"Navy",d:"DarkBlue",
    k:"Khaki",kd:"DarkKhaki",km:"Moccasin",kn:"NavajoWhite ",l:'Lavender',lb:"LavenderBlush",lp:"PowderBlue",lst:"LightSteelBlue",lsk:"LightSkyBlue",
    m:"Magenta",md:"DarkMagenta",moo:"MediumOrchid",mo:"Orchid",mf:"Fuchsia",mod:"DarkOrchid",
    nc:"Brown",n:"Chocolate",nd:"SaddleBrown",nn:"Sienna",np:"Peru",nr:"RosyBrown",ns:"SandyBrown",nw:"BurlyWood",o:"Orange",od:"DarkOrange",
    pl:"Pink",p:"LightPink",q:"HotPink",pr:"MistyRose ",pt:"Thistle",x:"DeepPink" ,
    r:"Red",rm:"Maroon",rcr:"Crimson",rD:"DarkRed",ro:"OrangeRed",ri:"IndianRed",rt:"Tomato",rfb:"FireBrick",
    s:"Salmon",sl:"LightSalmon",sd:"DarkSalmon",tn:"Tan",tb:"BlanchedAlmond",t:"Bisque",tq:"Beige",tw:"Wheat",tp:"PeachPuff",
    u:"Purple",ui:"Indigo",ub:"MediumSlateBlue",up:"Plum",ua:"MediumPurple",
    v:"Violet",vb:"BlueViolet",vd:"DarkViolet",vr:"MediumVioletRed",vrl:"PaleVioletRed",
    w:"White",wa: "Cornsilk",wb:"AliceBlue",wc:"WhiteSmoke",wf:"FloralWhite",wg:"GhostWhite",wh:"HoneyDew",wi:"Ivory",wl:"Linen",wm:"MintCream",wp:"PapayaWhip",wo:"OldLace",wq:"AntiqueWhite",ws:"SeaShell",ww:"Snow",wy:"LightCyan",
    X:"transparent",wz:"Azure",xs:"SkyBlue",xl:"LightBlue",xd:"DeepSkyBlue",
    y:"Yellow",yl:"LightYellow",yc:"LemonChiffon",yg:"Gold",z:"Black",zb:"DarkSlateBlue",zg:"DarkSlateGray"}
...
XMET={
    a:'arc',a2:'arcTo',b:'beginPath',c:'closePath',
    d:'drawImage',
    ...
    g:'createLinearGradient',rg:'createRadialGradient',
    r:'rect',
    S:'save',R:'restore',
    sc:'scale', tr:'translate', rt:'rotate',
    p:'createPattern',
    P:'putImageData',G:'getImageData',C:'createImageData',
    ip:'isPointInPath',is:'isPointInStroke',
    t:'transform',st:'setTransform',
    q:'quadraticCurveTo', z:'bezierCurveTo',
    x:'clearRect'}
...
GCO={s:'source-over',a:'source-atop',o:'source-out',i:'source-in',
...
ooo={
    ...
    E:EASE,
    t:TAG,i:INPUT,
    k:CLASS,r:ROLE,s:CSS,
    of:OVERFLOW,

    fl:FLOAT,
    u:CURSOR,w:OLWIDTH,p:POSITION,
    y:DISPLAY,

    tt:TEXTTRANSFORM,td:TEXTDECORATION,ta:TEXTALIGNMENT,tb:TEXTBASELINE,
    x:XMET,X:XPOP,z:PATTERN,
