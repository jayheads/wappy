...
//el
_n=function(a){if(U(a)){return qq('b')}}
_N=function(a){if(U(a)){return qq('N')}}
//img
...
xx=function xx(c){
    ...
    var g=G(arguments),c= C(X(c))||C(_a($c,g)),
...
//SAVE/RESTORE
    ...
    x.lW=x.lw=function(n){n=n||10;x({w:n});return x}
